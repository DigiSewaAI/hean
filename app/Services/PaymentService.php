 ...
 * ✅ FIXED: Proper MPDF config with Nepali font and watermark
 */
public function generateReceipt(Payment $payment): Receipt
{
    ...
    // 3. Generate PDF - ✅ WITH PROPER CONFIG (EXACTLY LIKE INVOICE)
    ...
    // ✅ MPDF CONFIG – EXACTLY SAME AS INVOICE CONTROLLER
    $mpdf = new Mpdf([
        'mode' => 'utf-8',
        'format' => 'A4',
        'orientation' => 'P',
...
protected function generateReceiptRemarks(Payment $payment): string
{
    ...
    // If payment has remarks, add them
