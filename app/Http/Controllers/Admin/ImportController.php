...
class ImportController extends Controller
{
     ...
     * ✅ 8.3 & 11: registration_number auto-generated via Hostel model event
     */
    public function store(Request $request)
    {
        ...
        try {
            foreach ($rows as $index => $row) {
                ...
                // ========================================================
                // ✅ 8.3 & 11: Registration create – WITHOUT registration_number
                // ========================================================
                ...
                // ========================================================
                // ✅ 8.3 & 11: Hostel create – event ले आफैं registration_number जनरेट गर्छ
                // ========================================================
                $hostel = Hostel::create([
                    ...
                    'featured' => false,
                    'owner_id' => null,
                    // 'registration_number' – event ले आफैं भर्छ
                ]);

                // ✅ ताजा मान ल्याउन refresh() – event पछि registration_number पाउन
                $hostel->refresh();
