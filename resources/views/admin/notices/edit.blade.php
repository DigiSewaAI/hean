...
@section('title', 'सूचना सम्पादन - HEAN Admin')

@section('content')
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
    <h2 style="font-size:1.5rem; font-weight:700; color:#0f172a; margin:0;">सूचना सम्पादन</h2>
    ...
    <form action="{{ route('admin.notices.update', $notice) }}" method="POST" enctype="multipart/form-data" class="dashboard-form">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" name="category" id="category" value="{{ old('category', $notice->category) }}" placeholder="जस्तै: Event, News, Workshop">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <small style="color:#64748b; display:block; margin-top:4px;">नयाँ छवि अपलोड गर्नुहोस् (वैकल्पिक)</small>
        </div>
