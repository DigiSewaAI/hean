...
@section('title', __('messages.edit_gallery_image') . ' - HEAN Admin')

@section('content')
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px; flex-wrap:wrap; gap:12px;">
    <h2 style="font-size:1.5rem; font-weight:700; color:#0f172a; margin:0;">
        <i class="fas fa-edit me-2" style="color:#0EA5E9;"></i> {{ __('messages.edit_gallery_image') }}
    </h2>
     ...
     style="max-width:300px; max-height:300px; border-radius:12px; box-shadow:0 4px 15px rgba(0,0,0,0.08);">
            ...
            <div class="form-group">
                <label for="image" style="font-weight:600; color:#1e293b; margin-bottom:6px; display:block;">
                    <i class="fas fa-upload me-1"></i> {{ __('messages.upload_new_image_optional') }}
                </label>
                ...
                <small style="color:#64748b; font-size:0.75rem; display:block; margin-top:4px;">
                    ...
                    {{ __('messages.edit_allowed_formats') }}
                </small>
                @error('image')
