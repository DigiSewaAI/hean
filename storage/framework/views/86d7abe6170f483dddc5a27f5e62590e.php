...
<?php $__env->startSection('title', __('messages.import_title')); ?>
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <h1 class="display-6 fw-bold mb-0" style="color: #0f172a;">
            ...
            <?php echo e(__('messages.import_title')); ?>
    ...
    <div class="card border-0 shadow-lg" style="border-radius: 20px; overflow: hidden;">
        ...
        <div class="card-header py-4" style="background: linear-gradient(135deg, #0EA5E9, #3B82F6); color: #fff; border: none;">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h5 class="fw-bold mb-0" style="font-size: 1.2rem;"><?php echo e(__('messages.import_title')); ?></h5>
        ...
        <div class="card-body" style="padding: 2rem 2.5rem;">
            ...
            <div class="alert alert-warning border-0 shadow-sm d-flex align-items-start gap-3" style="border-radius: 12px; background: #fffbeb; border-left: 5px solid #F59E0B;">
                ...
                <div>
                    <strong class="d-block" style="color: #92400e;"><?php echo e(__('messages.import_placeholder')); ?></strong>
                    <small style="color: #78350f;">कृपया सही ढाँचाको फाइल मात्र अपलोड गर्नुहोस्।</small>
                </div>
            </div>

            
            <form action="<?php echo e(route('admin.import.prepare')); ?>" method="POST" enctype="multipart/form-data" class="mt-3">
                <?php echo csrf_field(); ?>
                ...
                <div class="row g-4 align-items-end">
                    ...
                    <div class="col-md-8">
                        <label for="file" class="form-label fw-semibold" style="color: #1e293b; font-size: 0.9rem;">
                            ...
                            <?php echo e(__('messages.upload_csv_excel')); ?>
                    ...
                    <div class="col-md-4">
                        <button type="submit" class="btn w-100 btn-lg rounded-pill"
                            ...
                            <i class="fas fa-upload me-2"></i> <?php echo e(__('messages.prepare_import')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\hean\resources\views/admin/import/index.blade.php ENDPATH**/ ?>