...
<?php $__env->startSection('title', __('messages.admin_certificate_title')); ?>
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <h1 class="display-6 fw-bold mb-0" style="color: #0f172a;">
            ...
            <?php echo e(__('messages.admin_certificate_title')); ?>

        </h1>
        <span class="text-muted" style="font-size: 0.85rem;">
            <i class="far fa-clock me-1"></i>
            <?php echo e(now()->format('M d, Y H:i')); ?>
    ...
    <div class="card border-0 shadow-lg mb-4" style="border-radius: 20px; overflow: hidden;">
        <div class="card-header py-3" style="background: linear-gradient(135deg, #0EA5E9, #3B82F6); color: #fff; border: none;">
            <div class="d-flex align-items-center gap-2">
                ...
                <h5 class="fw-bold mb-0"><?php echo e(__('messages.generate_new_certificate')); ?></h5>
            </div>
        </div>
        <div class="card-body" style="padding: 2rem;">
            <form action="<?php echo e(route('admin.certificate.generate')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row g-4 align-items-end">
                    <div class="col-md-8">
                        <label for="registration_id" class="form-label fw-semibold" style="color: #1e293b; font-size: 0.9rem;">
                            ...
                            <?php echo e(__('messages.registration_id')); ?>
                        ...
                        <select name="registration_id" id="registration_id" class="form-select form-select-lg" 
                            ...
                            <option value=""><?php echo e(__('messages.select_registration')); ?></option>
                            <?php $__currentLoopData = \App\Models\Registration::with('hostel')->where('status', 'approved')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($reg->id); ?>">
                                    #<?php echo e($reg->id); ?> – <?php echo e($reg->hostel->name ?? __('messages.not_available')); ?>
                    ...
                    <div class="col-md-4">
                        <button type="submit" class="btn w-100 btn-lg rounded-pill"
                            ...
                            <i class="fas fa-certificate me-2"></i> <?php echo e(__('messages.generate_certificate')); ?>
    ...
    <div class="card border-0 shadow-lg" style="border-radius: 20px; overflow: hidden;">
        <div class="card-header py-3" style="background: linear-gradient(135deg, #8B5CF6, #7C3AED); color: #fff; border: none;">
            <div class="d-flex align-items-center gap-2">
                ...
                <h5 class="fw-bold mb-0"><?php echo e(__('messages.generated_certificates')); ?></h5>
                <span class="ms-auto badge bg-light text-dark rounded-pill px-3 py-2">
                    <i class="fas fa-file-alt me-1"></i> <?php echo e($certificates->total() ?? 0); ?>
                    ...
                    <table class="table table-hover align-middle" style="border-radius: 12px; overflow: hidden;">
                        <thead style="background: #f8fafc; border-bottom: 2px solid #e2e8f0;">
                            <tr>
                                <th style="padding: 12px 16px; font-weight: 600; color: #475569; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.03em;">
                                    <?php echo e(__('messages.certificate_number')); ?>

                                </th>
                                <th style="padding: 12px 16px; font-weight: 600; color: #475569; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.03em;">
                                    <?php echo e(__('messages.registration')); ?>

                                </th>
                                <th style="padding: 12px 16px; font-weight: 600; color: #475569; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.03em;">
                                    <?php echo e(__('messages.hostel')); ?>

                                </th>
                                <th style="padding: 12px 16px; font-weight: 600; color: #475569; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.03em;">
                                    <?php echo e(__('messages.issued_date')); ?>
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom: 1px solid #e2e8f0; transition: background 0.15s;">
                                ...
                                <td style="padding: 12px 16px; color: #1e293b;">#<?php echo e($cert->registration_id); ?></td>
                                <td style="padding: 12px 16px; color: #1e293b;">
                                    <?php echo e($cert->registration->hostel->name ?? __('messages.not_available')); ?>

                                </td>
                                <td style="padding: 12px 16px; color: #475569;">
                                    <i class="far fa-calendar-alt me-1" style="color: #94a3b8;"></i>
                                    <?php echo e($cert->issued_date ? \Carbon\Carbon::parse($cert->issued_date)->format('Y-m-d') : __('messages.not_available')); ?>

                                </td>
                                <td style="padding: 12px 16px; text-align: center;">
                                    <a href="<?php echo e(route('admin.certificates.download', $cert->id)); ?>" 
                                       ...
                                       style="background: linear-gradient(135deg, #22C55E, #16A34A); color: #fff; border: none; font-weight: 600; font-size: 0.75rem; box-shadow: 0 2px 10px rgba(34,197,94,0.25); transition: 0.3s;">
                                        <i class="fas fa-download me-1"></i> <?php echo e(__('messages.download')); ?>
            ...
            <?php else: ?>
                <div style="text-align: center; padding: 40px 20px;">
                    ...
                    <p style="color: #94a3b8; font-size: 0.95rem; margin: 0;">
                        <?php echo e(__('messages.no_certificates')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\hean\resources\views/admin/certificate/index.blade.php ENDPATH**/ ?>